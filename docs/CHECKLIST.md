...
Use this list when porting to a new language. Tick every box to have a working auto-login client. Extracted verbatim from the historical [SPECIFICATION.md](../SPECIFICATION.md).
